...
/**
 * The Inferred Relationship Repository for Custom Query
 */
public class InferredRelationshipRepositoryImpl implements InferredRelationshipRepositoryCustom {

	/** Logger */
	Logger log = LoggerFactory.getLogger(InferredRelationshipRepositoryImpl.class);

	private static final String TABLE = "INFERRED_RELATIONSHIP";
	private static final String RESULTSET_MAPPING = "InferredRelationshipWithName";
	...
	@Autowired
	public InferredRelationshipRepositoryImpl(JpaContext context, ConceptService conceptSvc) {
		this.em = context.getEntityManagerByManagedType(InferredRelationship.class);
	...
	/*
	 * (non-Javadoc)
	 * @see co.infoclinic.term.snomedct.repository.custom.InferredRelationshipRepositoryCustom#findListBySourceIdAndEffectiveTime(java.lang.String, java.lang.String)
	 */
	@Override
