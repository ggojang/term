    ...
    <Grid container>
      <Grid item md={12}>
        <Toolbar className={classes.toolbar} classes={{root: classes.toolbarRoot}} style={{ backgroundColor: "#ffffff", padding: "0 0 0 0"}}>
          ...
          >
            <Tab variant="body1" classes={{root: classes.tab1}} label="Member" {...a11yProps(0)} />
            <Tab variant="body1" classes={{root: classes.tab2}} label="Descriptor" {...a11yProps(1)} />
          </Tabs>
        </Toolbar>
